/// Interface
import { DataAdapterShape } from "../../interface";
/**
...
export interface DataAdapterConstructor<
  I extends DataAdapterShape<T, C, R>,
  C extends { async?: boolean } = I extends DataAdapterShape<any, infer V, any> ? V : any,
  T = I extends DataAdapterShape<infer U, any, any> ? U : any,
  R extends boolean = I extends DataAdapterShape<T, C, infer U> ? U extends boolean ? U : false : false,
